package com.heidan.util.kanjia;
...
public class PingDuoDuoReduceRule implements ReduceRule {
    ...
    public static void main(String[] args) {
        PingDuoDuoReduceRule rule = new PingDuoDuoReduceRule(50, 2);
        List<BigDecimal> list = rule.getReduceList(new BigDecimal("1900.00"), 10);
